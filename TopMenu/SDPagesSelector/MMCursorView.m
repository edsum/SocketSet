...
#import "MMSelectorCell.h"

static NSString *const cellIdentifier = @"selectorCell";

@interface MMCursorView ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, strong) UICollectionViewFlowLayout *layout;
@property (nonatomic, strong) UIScrollView *rootScrollView;
@end

@implementation MMCursorView
...
-(UICollectionView*)collectionView
{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[MMSelectorCell class] forCellWithReuseIdentifier:cellIdentifier];
...
{
    MMSelectorCell *cell = (MMSelectorCell*)[self.collectionView cellForItemAtIndexPath:indexPath];
    cell.selected = YES;
...
{
    MMSelectorCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
...
{
    MMSelectorCell *cell = (MMSelectorCell*)[collectionView cellForItemAtIndexPath:indexPath];
    cell.selected = NO;
}
